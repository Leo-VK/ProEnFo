...
|  2 | Winkler Score (WS) |          $$W S_{a, t}= \begin{cases}\delta, & L_t \leq y_t \leq U_t. \\ \delta+\frac{2\left(y_t-U_t\right)}{\alpha}, & y_t>U_t. \\ \delta+\frac{2\left(L_t-y_t\right)}{\alpha}, & y_t<L_t.\end{cases}$$         | probability |         evaluates whether the forecasting interval accurately captures actual observations, taking into account the width of the interval.         |
