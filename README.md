...
|  2 | Winkler Score (WS) |          a         | probability |         evaluates whether the forecasting interval accurately captures actual observations, taking into account the width of the interval.         |
...
| 13 |         MAE        |          $$\text{MASE} = \frac{1}{n} \sum_{t=1}^{n} \frac{\| y_t - F_t\|}{\frac{1}{n-1} \sum_{t=1}^{n} \| y_{t} - y_{t-1}\|}$$         |    point    |                               calculates the average of the absolute value of forecasting errors for all data points                               |
